...
var me = new Person('Mikael Airlangga', 28);
console.log(me);
...
var student = new Student('Airlangga Trianggoro', 19, 'Computer Science');
console.log(student);
console.log(student.hasMajor());
console.log(student.getDescription());

var traveller = new Traveller('Zelda Link', 20, 'Jakarta');
